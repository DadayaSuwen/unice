...
export default function Home() {
  ...
  return (
    <div className="app-wrapper">
        ...
        <div className="container-large hero-content">
          ...
          >
            ...
            <div className="hero-cta-buttons">
              ...
              >
                <svg className="icon-phone" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {isLoaded && (
            <div className="scroll-indicator">
              ...
              <span className="scroll-text">继续滚动</span>
            </div>
          )}
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className={`products-cta ${
            ...
            <Link href="/products" className="apple-button-primary">
              <span>查看所有产品</span>
              <svg className="icon-arrow-large" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </Link>
          </div>
      ...
      <section className="section py-section bg-white">
        <div className="container">
          <div className="section-header mb-16">
            <h2 className="section-title">现代化生产基地</h2>
            <p className="section-subtitle">世界一流的生产设施，确保产品质量与交付能力</p>
          </div>
      ...
      <section className="section py-section bg-gray-50">
        <div className="container">
          <div className="section-header mb-16">
        ...
        <div className="container-small">
          ...
          <div className="cta-buttons">
            ...
            <Link href="/products" className="cta-button-secondary">
              <svg className="icon-browse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
              浏览产品
            </Link>
